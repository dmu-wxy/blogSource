...
module.exports = {
  ...
  author: {
    ...
    name: 'meteor', // 必需
    link: 'https://github.com/dmu-wxy', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: '/img/face.jpg',
    name: 'Meteor',
    slogan: 'OS研发/Android渲染',
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      ...
      },
      {
        iconClass: 'icon-erji',
        title: '听音乐',
        link: 'https://y.qq.com/portal/profile.html#sub=song&tab=like&',
      },
    ],
  },
  footer: {
    ...
    copyrightInfo:
      'Meteor | <a href="#" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
